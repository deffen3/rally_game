...
pub fn build_weapon_store(world: &mut World) {
    ...
    let input_path_weapon_props = format!(
        "{}/assets/game/weapon_properties.ron",
        env!("CARGO_MANIFEST_DIR")
    );
    let input_path_spawn_chance = format!(
        "{}/assets/game/weapon_spawn_chance.ron",
        env!("CARGO_MANIFEST_DIR")
    );
    let input_path_gun_game_order = format!(
        "{}/assets/game/weapon_gun_game_order.ron",
        env!("CARGO_MANIFEST_DIR")
    );
    let input_path_selection_order = format!(
        "{}/assets/game/weapon_selection_order.ron",
        env!("CARGO_MANIFEST_DIR")
    );
